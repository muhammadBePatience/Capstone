...
# Scatter plot for displaying correlation between Total_Rain and other attributes 
...
```{r echo=TRUE}
#ggplot(Actual_Data_Final,aes(Season)) +
#  geom_bar(aes(fill = Rained), position = "fill") +
#  geom_hline(aes(yintercept = prop.table(table(Actual_Data_Final$Rained))["No"]),
...
Actual_Data_Featuers <- Actual_Data[,c("Total_Rain","Min_Temp","Max_Temp","Mean_Temp",
                                       "Total_Precip","Heat_Deg_Days")]
...
#Because the our train data is scewed, Accuracy may be not a c
